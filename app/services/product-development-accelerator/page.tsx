...
import { provenCardPadding, provenButtonWidth, provenTouchFeedback } from '@/lib/utils/responsive-utilities'
...
const ProductDevelopmentAcceleratorPage = () => {
  ...
  background="white"
  >
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto px-4">
  {[
  {
  icon: DollarSign,
  ...
  {/* Our Solution Section */}
      <UnifiedSection
        ...
        background="gray"
      >
        <div className={`grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto ${provenCardPadding()}`}>
  {[
  {
  phase: "01",
  ...
  className="group"
  >
  <div className={`bg-white rounded-2xl  shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 h-full flex flex-col ${provenCardPadding()}`}>
  ...
  <div className="text-xl sm:text-2xl font-bold text-white">{step.phase}</div>
  </div>
  <div className="flex-1">
  <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">
  Phase {step.phase}: {step.title}
  </h3>
  <div className="text-sm text-blue-600 font-medium bg-blue-100 px-3 py-1 inline-block rounded-lg mb-3 sm:mb-4">
  {step.duration}
  </div>
  </div>
  </div>
  ...
  background="white"
  >
  <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-7xl mx-auto ${provenCardPadding()}`}>
  {[
  {
  icon: Users,
  ...
  <div className={`grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12 lg:mb-16 ${provenCardPadding()}`}>
  {[
  {
  icon: '👨‍💼',
  ...
  className="group"
  >
  <div className={`bg-white/10 backdrop-blur-sm rounded-2xl  border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105 h-full flex flex-col ${provenCardPadding()}`}>
  ...
  <p className="text-blue-200 leading-relaxed mb-3 sm:mb-4 text-center flex-grow">
  ...
  <div className="max-w-4xl mx-auto text-center">
      <div className={`bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-100 pb-8 sm:pb-12 lg:pb-16 ${provenCardPadding()}`}>
  ...
  <h3 className="text-xl sm:text-2xl font-bold text-gray-900">The Bridge Between Two Worlds</h3>
  </div>
  ...
  variant="primary" 
  size="lg"
  className="group w-full sm:w-auto px-3 sm:px-4 sm:px-6 lg:px-8 py-3 sm:py-4 text-xs sm:text-base active:scale-[0.98] sm:active:scale-100"
  >
  <Globe className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 group-hover:rotate-12 transition-transform duration-300 flex-shrink-0" />
  <span className="whitespace-nowrap text-center flex-1">Learn More About My Hub & Spoke Model</span>
  <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 ml-1 sm:ml-2 group-hover:translate-x-1 transition-transform duration-300 flex-shrink-0" />
  </Button>
  </Link>
  </motion.div>
  ...
  {/* Two-Column Layout */}
  <div className={`grid md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-center ${provenCardPadding()}`}>
  {/* Left: What You Get */}
  <div className={`bg-white/10 backdrop-blur-sm rounded-2xl  border border-white/20 ${provenCardPadding()}`}>
  <h3 className="text-lg sm:text-xl font-bold text-white mb-4 sm:mb-6">Personal Consultation Includes:</h3>
  ...
  <p className="text-blue-200 mb-4 sm:mb-6">
  Personal response within 24 hours
  </p>
  <Button 
  variant="accelerator" 
  size="hero" 
  className={`w-full rounded-lg ${provenButtonWidth()}`}
